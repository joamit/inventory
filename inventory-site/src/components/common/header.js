            ...
            <ul className="nav navbar-top-links navbar-right">
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-messages">
                        ...
                        <li className="divider"/>
                        <li>
                            <a className="text-center" href="/userMessages">
                ...
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-tasks">
                        ...
                        <li className="divider"/>
                        <li>
                            <a className="text-center" href="/warehouseStats">
                ...
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-alerts">
                        ...
                        <li className="divider"/>
                        <li>
                            <a className="text-center" href="/userAlerts">
                ...
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu dropdown-user">
                        <li><a href="/userProfile"><i className="fa fa-user fa-fw"/> My Profile</a>
                        </li>
                        <li><a href="/userSettings"><i className="fa fa-gear fa-fw"/> Settings</a>
                        </li>
                        <li className="divider"/>
                        <li><a href="/userLogin"><i className="fa fa-sign-out fa-fw"/> Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
